...
export const TermsModal: React.FC = observer(() => {
  ...
  return (
            <Dialog
              fullScreen
              open={showTermsModal}
              // onClose={setShowTermsModal.bind(this, false)}
              ...
              <>
                <Toolbar>
                  <IconButton
                    ...
                    color="inherit"
                    onClick={setShowTermsModal.bind(this, false)}
                    aria-label="close"
                  >
                    <CloseIcon style={{fontSize: 43}}/>
                  </IconButton>
                </Toolbar>
                {'https://www.lidvizion.com/terms-of-use-app/' && (
                  <CardMedia
                    sx={{ height: '100%' }}
                    component="iframe"
                    src={'https://www.lidvizion.com/terms-of-use-app/'}
                  />
                )}
              </>
            </Dialog>
